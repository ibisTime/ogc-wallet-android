...
public class EditInputFilter implements InputFilter {
     ...
     * @param pointerLength
     */
    public EditInputFilter(int pointerLength) {
...
//        //
//            Toast.makeText(MyApplication.getInstance(), MyApplication.getInstance().getResources().getString(R.string.appreciate_input), Toast.LENGTH_SHORT).show();

...
public class AppFragmentAdapter extends BaseQuickAdapter<DAppModel, BaseViewHolder> {

    public AppFragmentAdapter(@Nullable List<DAppModel> data) {
        super(R.layout.item_fragment_app, data);
    }

...
public class SignUpActivity extends AbsStatusBarTranslucentActivity implements SendCodeInterface {
    ...
    private boolean agreeFlag = true; // 是否统一协议，默认同意
...
//        });
        ...
        mBinding.tvProtocol.setOnClickListener(view -> {
            ...
            WebViewActivity.openkey(SignUpActivity.this, getString(R.string.pop_protocol), key);
        });
    ...
    private void signUp() {
        ...
        if (TAB_MOBILE == tabPosition) {
            ...
            code = "805043";
            map.put("email", mBinding.edtEmail.getText().toString().trim());
            map.put("captcha", mBinding.edtCode.getText().toString().trim());
        }
